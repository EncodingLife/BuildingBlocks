...
//         assert_eq!(result[0], Instruction::ReplaceSelf(CellType::None, 0));
//     }
...
//         // Up(010)-Nucleus(100)-Create(01)
//         let result = decode_bna(0b010_100_01);

//         assert_eq!(result.len(), 2);
//         assert_eq!(
//             result[0],
//             Instruction::Create(CellType::Nucleus, MapDirection::Up, 0)
//         );
//         assert_eq!(result[1], Instruction::default());
//     }
